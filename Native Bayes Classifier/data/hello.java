...
public class hello {
	public static void main(String[] args) {
		if(args.length<3){
			...
			System.out.println("You should add a third parameter as N to do Vocabulary modification");
		...
		BufferedReaderExample1 b = new BufferedReaderExample1(args[0], args[1],n);}
...
class BufferedReaderExample1 {
	...
	public BufferedReaderExample1(String para1, String para2,int n) {
		...
		String testdata = para2;
		{
			...
			Set<String> buttomV= new HashSet<String>();
	...
	public int readfileandcalculation(String input, double prior_Con,
			double prior_Lib, int V, int Con, int Lib) {
		BufferedReader br2 = null;
				...
				while ((sCurrentLine = br2.readLine()) != null) {
					if (Vocabulary.contains(sCurrentLine)) {
						...
						if (mytableC.containsKey(sCurrentLine)) {
							...
							tmpC = (double) (mytableC.get(sCurrentLine) + 1)
									/ (V + Con);
						} else {
							tmpC = (double) (1.0 / (V + Con));
						}
						if (mytableL.containsKey(sCurrentLine)) {

							tmpL = (double) (mytableL.get(sCurrentLine) + 1)
									/ (V + Lib);
						} else {
							tmpL = (double) (1.0 / (V + Lib));
						}
